...
const TimeChangeRule CDisplayClock::myDST PROGMEM= {"DST", Last, Sun, Mar, 3, +3*60};
const TimeChangeRule CDisplayClock::mySTD PROGMEM= {"STD", Last, Sun, Oct, 4, +2*60};

CDisplayClock::CDisplayClock():myTZ(myDST, mySTD) {
	memset(buffMin,0,sizeof(buffMin));
}
time_t CDisplayClock::getLocalTime(){
